...
public class ApplicationServiceTests
{
    ...
    public void GedFileInfo_ReturnedCorrectly_WhenServiceCalled()
    {
        ...
        {
            new (){DateImported = "1 Jan 2023", FileName = "x", FileSize = 1, Id = 2},
            new (){DateImported = "2 Jan 2023", FileName = "x", FileSize = 1, Id = 1}
        };
        
        _mockPersistedCacheRepository
            .Setup(s => s.GetImportData())
            .Returns(imports);

        var gis = new GetGedFiles(_mockPersistedCacheRepository.Object, _mockLog.Object, mapper);
